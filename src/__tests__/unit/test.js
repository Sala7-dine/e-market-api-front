describe('CartContext - Unit Tests', () => {
  ...
  describe('calculateTotal', () => {
    ...
    it('should calculate total with multiple quantities', () => {
      mockCart = [
        { id: 1, name: 'Produit A', price: 15, quantity: 3 }
      ];
    ...
    it('should handle decimal prices correctly', () => {
      mockCart = [
        ...
        { id: 2, name: 'Produit B', price: 15.50, quantity: 1 }
      ];
    ...
    it('should successfully update product quantity', async () => {
      ...
      const mockResponse = {
        data: {
          ...
          cart: [
            { id: 1, name: 'Produit A', price: 25, quantity: 5 }
          ],
        },
      };
  ...
  describe('applyDiscount', () => {
    ...
    it('should handle invalid discount code', async () => {
      ...
      await expect(mockAxios.post('/cart/discount', { code: 'INVALID' })).rejects.toEqual(mockError);
    });
    ...
    it('should handle expired discount code', async () => {
      ...
      await expect(mockAxios.post('/cart/discount', { code: 'EXPIRED' })).rejects.toEqual(mockError);
    });
  });
