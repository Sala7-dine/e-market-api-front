            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-6">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
                        <Link to="/" className="hover:text-[#FF6B6B]">Home</Link>
                        <span>/</span>
                                            ...
                                            {tempImages.map((image, index) => (
                                                <button 
                                                    ...
                                                    className={`w-20 h-20 bg-gray-100 rounded-lg overflow-hidden border-2 transition-colors duration-300 ${
                                                        selectedImage === index ? 'border-[#FF6B6B]' : 'border-gray-300 hover:border-[#FF6B6B]'
                                                    }`}
                                                >
                                                    <img 
                                                        src={image} 
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                {product.stock < 5 && product.stock > 0 && (
                                    <span className="bg-[#FF6B6B] text-white text-xs px-3 py-1 rounded">Limited Stock</span>
                                )}
                                {product.stock === 0 && (
                                    <span className="bg-gray-500 text-white text-xs px-3 py-1 rounded">Out of Stock</span>
                                )}
                            </div>
                            ...
                            <div className="border-t border-gray-200 pt-6">
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="h-6 w-12 bg-gray-200 rounded flex items-center justify-center text-xs font-bold">VISA</div>
                                    <div className="h-6 w-12 bg-gray-200 rounded flex items-center justify-center text-xs font-bold">MC</div>
                                    <div className="h-6 w-12 bg-gray-200 rounded flex items-center justify-center text-xs font-bold">PP</div>
                                    <div className="h-6 w-12 bg-gray-200 rounded flex items-center justify-center text-xs font-bold">GPay</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-12 bg-gray-50">
                <div className="container mx-auto px-6">
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        {activeTab === 'shipping' && (
                            <div>
                                <p className="text-gray-600 leading-relaxed">Free shipping on orders over $50. Standard delivery takes 3-5 business days.</p>
                            </div>
                        )}
                        ...
                        {tempImages.map((image, index) => (
                            <div key={index} className="group">
                                ...
                                <div>
                                    ...
                                    <h3 className="text-base font-medium text-gray-800 mb-2">Related Product {index + 1}</h3>
