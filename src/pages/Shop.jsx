                        ...
                        <aside className="lg:w-1/4">
                            ...
                            <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                                ...
                                <ul className="space-y-3">
                                    <li>
                                        <Link to="/about" className="text-gray-600 text-sm hover:text-[#FF6B6B] transition-colors duration-300">
                                            À propos
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/blog" className="text-gray-600 text-sm hover:text-[#FF6B6B] transition-colors duration-300">
                                            Blog
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/contact" className="text-gray-600 text-sm hover:text-[#FF6B6B] transition-colors duration-300">
                                            Contact
                                        </Link>
                                    </li>
                                </ul>
                                    ...
                                    {categories.map((category) => (
                                        <li key={category.id}>
                                            <button
                                                ...
                                                className={`text-sm hover:text-[#FF6B6B] transition-colors duration-300 ${
                                                    selectedCategory === category.id ? 'text-[#FF6B6B] font-medium' : 'text-gray-600'
                                                }`}
                                            >
                                                {category.name}
                                            </button>
                            ...
                            <div className="flex flex-wrap items-center justify-between mb-8 pb-4 border-b border-gray-200">
                                <div className="flex items-center gap-4 mb-4 lg:mb-0">
                                    ...
                                    <span className="text-gray-600 text-sm">
                                        Affichage de {Math.min(filteredProducts.length, itemsPerPage)} sur {filteredProducts.length} résultats
                                    </span>
                                </div>
