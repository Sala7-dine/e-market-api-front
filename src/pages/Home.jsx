  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        >
          <img
            src="   https://cdn-icons-png.flaticon.com/512/3661/3661482.png "
            width="50"
            height="50"
            alt=""
            title=""
      ...
      <div className="bg-white py-20 p-4 mx-auto max-w-[1200px]">
        <div className="mb-6 sm:mb-8 flex flex-col gap-3">
          ...
          <p className="text-sm font-meduim text-slate-700">
            Shop great deals on Home Decor, Crystals Candles and more.
          </p>
        </div>
                  ...
                  <img
                    src={
                      product.images?.[0]?.startsWith("http")
                        ? product.images[0]
                        : `https://res.cloudinary.com/dbrrmsoit/image/upload/${product.images?.[0]}` ||
