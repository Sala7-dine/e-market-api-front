                        ...
                        <div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 mb-6">
                                ...
                                >
                                    ...
                                    <svg className={`w-5 h-5 ${deliveryMethod === "delivery" ? "text-blue-500" : "text-gray-400"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                >
                                    ...
                                    <svg className={`w-5 h-5 ${deliveryMethod === "pickup" ? "text-blue-500" : "text-gray-400"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <label htmlFor="terms" className="text-sm text-gray-600">
                                        J'ai lu et j'accepte les <a href="#" className="text-blue-500 hover:underline">Conditions générales</a>.
                                    </label>
                                </div>
                            </form>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4 mb-6">
                                {cartItems.length === 0 ? (
                                    ...
                                    cartItems.map((item, index) => (
                                        <div key={item.productId?._id || index} className="flex gap-4 pb-4 border-b border-gray-200">
                                            ...
                                            <div className="flex-1">
                                                <h3 className="font-semibold text-gray-900 mb-1">{item.productId?.title || 'Produit'}</h3>
                            ...
                            <div className="bg-gray-50 rounded-lg p-4">
                                ...
                                <p className="text-sm text-gray-500">
                                    Vos informations financières et personnelles sont sécurisées lors de chaque transaction.
                                </p>
                            </div>
                        </div>
                    </div>
